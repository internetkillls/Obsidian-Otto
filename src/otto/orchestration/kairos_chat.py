...
from .telegram_router import route_telegram_heartbeat_message
...
class KAIROSChatHandler:
    ...
    def handle(self, message: str) -> dict[str, Any]:
        ...
        heartbeat_route = route_telegram_heartbeat_message(message, schedule_fallback=False)
        if heartbeat_route is not None:
            return heartbeat_route
        ...
        scheduled_route = route_telegram_heartbeat_message(message, schedule_fallback=True)
