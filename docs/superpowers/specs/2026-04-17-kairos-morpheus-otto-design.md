...
KAIROS (Greek: the decisive moment) is the left hemisphere — analytical, sequential, telemetric, scoring, classifying. All data originates here. It is the authoritative source of truth about the world and about Joshua's state.
